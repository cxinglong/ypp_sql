      ...
      <div>
        <Form ref="userForm" :model="userForm" :label-width="100" label-position="right">
          ...
          <FormItem label="具体权限：">
            ...
            <FormItem label="可访问的业务项目:" v-if="formItem.ddl === '是'">
              <p>{{formItem.ddlcon}}</p>
            </FormItem>
            <FormItem label="DML是否可见:">
              <p>{{formItem.dml}}</p>
            </FormItem>
            <FormItem label="可访问的业务项目:" v-if="formItem.dml === '是'">
              <p>{{formItem.dmlcon}}</p>
            </FormItem>
            <FormItem label="查询是否可见:">
              <p>{{formItem.query}}</p>
            </FormItem>
            <FormItem label="可访问的业务项目:" v-if="formItem.query === '是'">
            ...
            <FormItem label="可访问的业务项目:" v-if="formItem.dic === '是'">
              <p>{{formItem.diccon}}</p>
            </FormItem>
        ...
        <FormItem label="权限组" prop="authgroup">
          ...
          <template>
            <FormItem label="所拥有的权限:">
              ...
              <FormItem label="可访问的业务项目:" v-if="permission.ddl === '是'">
                <p>{{permission.ddlcon}}</p>
              </FormItem>
              <FormItem label="DML是否可见:">
                <p>{{permission.dml}}</p>
              </FormItem>
              <FormItem label="可访问的业务项目:" v-if="permission.dml === '是'">
                <p>{{permission.dmlcon}}</p>
              </FormItem>
              <FormItem label="查询是否可见:">
                <p>{{permission.query}}</p>
              </FormItem>
              <FormItem label="可访问的业务项目:" v-if="permission.query === '是'">
              ...
              <FormItem label="可访问的业务项目:" v-if="permission.dic === '是'">
