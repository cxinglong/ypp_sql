...
CREATE TABLE `core_usermessage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `to_user` varchar(50) COLLATE utf8_bin NOT NULL,
  `from_user` varchar(50) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `core_globalpermissions` VALUES (1, 'global', '{\'host\': \'\', \'port\': \'\', \'user\': \'\', \'password\': \'\', \'back_host\': \'\', \'back_port\': \'\', \'back_user\': \'\', \'back_password\': \'\'}', '{\'type\': \'\', \'host\': \'\', \'sc\': \'\', \'domain\': \'\', \'user\': \'\', \'password\': \'\'}', '{\'webhook\': \'\', \'smtp_host\': \'\', \'smtp_port\': \'\', \'user\': \'\', \'password\': \'\', \'to_user\': \'\', \'mail\': False, \'ding\': False}', '{\'limit\': \'\', \'con_room\': [\'Aliyun\'], \'foce\': \'\', \'multi\': False, \'query\': False, \'sensitive_list\': [], \'sensitive\': \'\'}');
INSERT INTO `core_account` VALUES (1, 'pbkdf2_sha256$100000$oaPFGaxceCwA$Cd6CiOJVStztz2Ykk/fi9ezUiPy6QZsPVI3KZU8pdwc=', NULL, 0, 'admin', '', '', '', 1, 1, '2018-07-26 07:15:33.931971', 'admin', '', 'admin');
COMMIT;
